...
router.get('/job/:jobId/summary', paymentController.getJobPayments);
router.get('/:id', canProcessPayments, paymentController.getPaymentById);
...
router.post(
  '/mpesa/stk-push',
  canProcessPayments,
  paymentValidators.mpesaSTK,
  handleValidation,
  paymentController.initiateMpesaSTK
);
